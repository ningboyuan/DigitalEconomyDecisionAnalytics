...
# Output data
Sample_Obs.to_csv(os.getcwd() + '/DEDA_HMM/Sample_Obs.csv')
Sample_Hid.to_csv(os.getcwd() + '/DEDA_HMM/Sample_Hid.csv')
...
plot_timeseries(ax, sample.index, sample['Observation'], 'blue', 'index', 'Dice Observations', linestyle='None',
                marker='o')
ax2 = ax.twinx()
...
fig.savefig(os.getcwd() + '/DEDA_HMM/First {} cases of dice sequence.png'.format(n), dpi=300)